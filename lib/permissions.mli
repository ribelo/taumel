...
val prompt_selection_plan :
  ui_available:bool -> title:string -> menu_option list -> prompt_plan
...
val resolve_active :
  host_sandbox_preset:Capability_profile.sandbox_preset option ->
  host_network_mode:Sandbox.network_mode option ->
  host_no_sandbox:bool option ->
  session_isolated_child:bool ->
  persisted ->
  active

...
val user_cancel_task : now:int -> task_id:string -> store -> (t, string) result

val user_delete_task : now:int -> task_id:string -> store -> (t, string) result
...
val account_usage : now:int -> time_delta_seconds:int -> token_usage -> t -> t

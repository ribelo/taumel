...
- When a prompt contains at least one candidate mention, the system shall scan the sources at that moment and use the result for that turn only, holding no cache between turns. ^skr-ds03

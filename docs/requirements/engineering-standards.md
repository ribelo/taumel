...
- OCaml source shall separate consecutive top-level declarations with exactly one blank line, and the project shall enforce the rule with an automated gate check rather than manual review. ^eng-0j8i

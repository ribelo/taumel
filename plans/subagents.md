...
- **agent-tc14** (ubiquitous): The model-facing `agent_spawn` metadata shall position generic delegation for substantial execution tasks whose primary outcome is an action or artifact and that benefit from independent asynchronous execution.

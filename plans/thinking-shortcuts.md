...
- **think-ks03** (ubiquitous): Directional thinking shortcuts shall walk the Pi thinking order `off`, `minimal`, `low`, `medium`, `high`, `xhigh`, `max`, clamp at the ends, and never wrap.

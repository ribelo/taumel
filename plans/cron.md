...
- **cron-cm07** (event-driven): Pressing enter on a task in the list view shall open that task's details. The command workflow shall provide task shortcuts, mutation status, confirmation, prompt and schedule editing, and the details and confirmation views.

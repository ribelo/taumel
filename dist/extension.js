...
var PlanPresentationTaskSchema = Type.Object({
...
var PlanPresentationSchema = Type.Object({
  ...
  tasks: Type.Array(PlanPresentationTaskSchema, { minItems: 1 }),
...
var PlanTaskSchema = Type2.Object({
  taskId: Type2.String({ minLength: 1 }),
  title: Type2.String({ minLength: 1 }),
  description: Type2.Union([Type2.String(), Type2.Null()]),
  status: Type2.Union([
  ...
  depends_on: Type2.Array(Type2.String({ minLength: 1 })),
  origin: Type2.Union([Type2.Literal("user"), Type2.Literal("agent")])
}, { additionalProperties: false });
...
var EditReplacementSchema = Type3.Object({
...
var EmptyParamsSchema = Type3.Object({}, { $id: "EmptyParams", additionalProperties: false });
var ExecCommandParamsSchema = Type3.Object({
  cmd: Type3.String({ minLength: 1, pattern: "\\S", description: "The bash command to run." }),
  ...
  yield_time_ms: Type3.Optional(Type3.Number({
  ...
  max_output_tokens: Type3.Optional(Type3.Integer({
    minimum: 0,
...
var WriteStdinParamsSchema = Type3.Object({
  session_id: Type3.Integer({
    description: "Exact session id returned by exec_command."
  }),
  chars: Type3.Optional(Type3.String({
  ...
  output_mode: Type3.Optional(Type3.Union([Type3.Literal("delta"), Type3.Literal("status")], {
...
var ApplyPatchParamsSchema = Type3.Object({
  input: Type3.String({
    minLength: 1,
    description: "The complete patch in *** Begin Patch format."
  })
}, { $id: "ApplyPatchParams", additionalProperties: false });
var WriteParamsSchema = Type3.Object({
  path: Type3.String({
    minLength: 1,
    description: "Path to the file, relative to the current working directory or absolute."
  }),
  content: Type3.String({ description: "UTF-8 text to write exactly as provided." }),
  mode: Type3.Optional(Type3.Union([Type3.Literal("overwrite"), Type3.Literal("append")], {
...
var ViewMediaParamsSchema = Type3.Object({
  path: Type3.String({
    minLength: 1,
...
var CreateTaskItemSchema = Type3.Object({
  id: Type3.Optional(Type3.String({ description: "Optional explicit task identity, unique within this plan. Omit to auto-generate a task- identity." })),
  title: Type3.String({ description: "Short statement of the work. Trimmed; must not be empty." }),
  description: Type3.Optional(Type3.String({ description: "Optional longer specification of this step." })),
  depends_on: Type3.Optional(Type3.Array(Type3.String(), {
...
var CreateTaskParamsSchema = Type3.Object({ tasks: Type3.Array(CreateTaskItemSchema, { minItems: 1 }) }, { $id: "CreateTaskParams", additionalProperties: false });
var UpdateTaskParamsSchema = Type3.Object({
  taskId: Type3.String(),
  status: Type3.Optional(Type3.Union([
    Type3.Literal("pending"),
    Type3.Literal("in_progress"),
...
var UpdatePlanParamsSchema = Type3.Object({
  status: Type3.Union([Type3.Literal("active"), Type3.Literal("blocked")], {
...
var CronCreateParamsSchema = Type3.Object({
  cron: Type3.String({
    minLength: 1,
...
var CronDeleteParamsSchema = Type3.Object({
  id: Type3.String({
...
var QueryThreadsParamsSchema = Type3.Object({
  query: Type3.String({
    minLength: 1,
    maxLength: 500,
  ...
  scope: Type3.Optional(Type3.Union([Type3.Literal("current_workspace"), Type3.Literal("all")], {
  ...
  includeTools: Type3.Optional(Type3.Boolean({
...
var ThreadLocatorSchema = Type3.Object({
  threadID: Type3.String({ minLength: 1, description: "Thread ID carried by the locator." }),
  sourcePath: Type3.Optional(Type3.String({
    minLength: 1,
    description: "Persisted source path carried by the locator for exact source recovery. Copy it unchanged."
  })),
  entryID: Type3.Optional(Type3.String({ minLength: 1, description: "Persisted entry ID identifying the matched event." })),
  line: Type3.Optional(Type3.Integer({
    minimum: 1,
...
var ReadThreadParamsSchema = Type3.Object({
  ...
  locator: Type3.Optional(Type3.Object({
    threadID: Type3.String({ minLength: 1, description: "Thread ID carried by the locator." }),
    sourcePath: Type3.Optional(Type3.String({
      minLength: 1,
      description: "Persisted source path carried by the locator for exact source recovery. Copy it unchanged."
  ...
  entryID: Type3.Optional(Type3.String({ minLength: 1, description: "Entry ID to target when using mode = window without a locator." })),
  line: Type3.Optional(Type3.Integer({
    minimum: 1,
    description: "Persisted JSONL line number to target when using mode = window without a locator."
  })),
  mode: Type3.Optional(Type3.Union([Type3.Literal("overview"), Type3.Literal("window"), Type3.Literal("full")], {
  ...
  around: Type3.Optional(Type3.Integer({
    minimum: 0,
    maximum: 10,
...
var RalphTaskParamsSchema = Type3.Object({
...
var AgentTierSchema = Type3.Union([Type3.Literal("low"), Type3.Literal("medium"), Type3.Literal("high")], { description: "The generic agent's capacity tier. Defaults to medium." });
var AgentIsolationSchema = Type3.Union([Type3.Literal("none"), Type3.Literal("worktree")], {
...
var AgentSpawnParamsSchema = Type3.Object({
  ...
  tier: Type3.Optional(AgentTierSchema),
  isolation: Type3.Optional(AgentIsolationSchema)
}, { $id: "AgentSpawnParams", additionalProperties: false });
var FinderParamsSchema = Type3.Object({
  query: Type3.String({
    minLength: 1,
...
var OracleParamsSchema = Type3.Object({
  message: Type3.String({
    minLength: 1,
...
var AgentSendParamsSchema = Type3.Object({
  ...
  interrupt: Type3.Optional(Type3.Boolean({
...
var AgentWaitParamsSchema = Type3.Object({
  run_ids: Type3.Array(Type3.String({ minLength: 1 }), {
    minItems: 1,
    description: "Unique owner-scoped run IDs that all belong to the current session."
  }),
  timeout_seconds: Type3.Optional(Type3.Number({
    minimum: 0,
...
var AgentCloseParamsSchema = Type3.Object({
  agent_id: Type3.String({ minLength: 1, description: "The owner-scoped handle of the identity to close permanently." }),
  delete_worktree: Type3.Optional(Type3.Boolean({
...
var OpenAiUsageHostAuthSchema = Type4.Object({
  providerKey: Type4.String({ minLength: 1 }),
  credentialKey: Type4.String({ minLength: 1 }),
  source: Type4.String({ minLength: 1 })
}, { $id: "OpenAiUsageHostAuth", additionalProperties: false });
var KimiUsageHostAuthSchema = Type4.Object({ providerKey: Type4.String({ minLength: 1 }), source: Type4.String({ minLength: 1 }) }, { $id: "KimiUsageHostAuth", additionalProperties: false });
var OpenAiUsageHostLookupFactsSchema = Type4.Object({
  apiKeyPresent: Type4.Boolean(),
  credential: Type4.Optional(Type4.Unknown()),
  token: Type4.Optional(Type4.String()),
  tokenError: Type4.Optional(Type4.String())
}, { $id: "OpenAiUsageHostLookupFacts", additionalProperties: false });
var KimiUsageHostLookupFactsSchema = Type4.Object({
  token: Type4.Optional(Type4.String()),
  tokenError: Type4.Optional(Type4.String())
}, { $id: "KimiUsageHostLookupFacts", additionalProperties: false });
var hostParamsBase = { apiKeyPresent: Type4.Boolean(), credential: Type4.Optional(Type4.Unknown()) };
var kimiHostParamsBase = { apiKeyPresent: Type4.Boolean() };
var OpenAiUsageHostParamsPresentSchema = Type4.Object({ ...hostParamsBase, tokenState: Type4.Literal("present"), token: Type4.String({ minLength: 1 }) }, { $id: "OpenAiUsageHostParamsPresent", additionalProperties: false });
var OpenAiUsageHostParamsMissingSchema = Type4.Object({ ...hostParamsBase, tokenState: Type4.Literal("missing") }, { $id: "OpenAiUsageHostParamsMissing", additionalProperties: false });
var OpenAiUsageHostParamsErrorSchema = Type4.Object({ ...hostParamsBase, tokenState: Type4.Literal("error"), tokenError: Type4.String({ minLength: 1 }) }, { $id: "OpenAiUsageHostParamsError", additionalProperties: false });
var OpenAiUsageHostParamsSchema = Type4.Union([
...
var KimiUsageHostParamsPresentSchema = Type4.Object({ ...kimiHostParamsBase, tokenState: Type4.Literal("present"), token: Type4.String({ minLength: 1 }) }, { $id: "KimiUsageHostParamsPresent", additionalProperties: false });
var KimiUsageHostParamsMissingSchema = Type4.Object({ ...kimiHostParamsBase, tokenState: Type4.Literal("missing") }, { $id: "KimiUsageHostParamsMissing", additionalProperties: false });
var KimiUsageHostParamsErrorSchema = Type4.Object({ ...kimiHostParamsBase, tokenState: Type4.Literal("error"), tokenError: Type4.String({ minLength: 1 }) }, { $id: "KimiUsageHostParamsError", additionalProperties: false });
var KimiUsageHostParamsSchema = Type4.Union([
  KimiUsageHostParamsPresentSchema,
  KimiUsageHostParamsMissingSchema,
  KimiUsageHostParamsErrorSchema
], { $id: "KimiUsageHostParams" });
var UsagePairHostParamsSchema = Type4.Object({ openai: OpenAiUsageHostParamsSchema, kimi: KimiUsageHostParamsSchema }, { $id: "UsagePairHostParams", additionalProperties: false });
// src/bridge-core-contracts.ts
var ActiveToolsSyncFactsSchema = Type5.Object({ tools: Type5.Array(Type5.String()), ctx: Type5.Optional(Type5.Unknown()) }, { $id: "ActiveToolsSyncFacts", additionalProperties: false });
var ActiveToolsPlanSchema = Type5.Object({
  changed: Type5.Boolean(),
  tools: Type5.Array(Type5.String())
}, { $id: "ActiveToolsPlan", additionalProperties: false });
var ChildPermissionRefreshPlanSchema = Type5.Object({ permissions: PermissionsStateV1Schema }, { $id: "ChildPermissionRefreshPlan", additionalProperties: false });
var CommandSpecSchema = Type5.Object({
  name: Type5.String({ minLength: 1 }),
  description: Type5.String()
}, { $id: "CommandSpec", additionalProperties: false });
var CommandSpecsResultSchema = Type5.Object({ specs: Type5.Array(CommandSpecSchema) }, { $id: "CommandSpecsResult", additionalProperties: false });
var ToolNamesResultSchema = Type5.Object({ names: Type5.Array(Type5.String({ minLength: 1 })) }, { $id: "ToolNamesResult", additionalProperties: false });
var ThreadCatalogFactsSchema = Type5.Object({ cwd: Type5.String(), home: Type5.String(), override: Type5.Optional(Type5.String()) }, { $id: "ThreadCatalogFacts", additionalProperties: false });
var ThreadCatalogScanSchema = Type5.Object({
  root: Type5.String({ minLength: 1 }),
  maxDepth: Type5.Integer({ minimum: 0 }),
  maxFiles: Type5.Integer({ minimum: 1 }),
  suffix: Type5.String({ minLength: 1 })
}, { $id: "ThreadCatalogScan", additionalProperties: false });
var ThreadCatalogScansResultSchema = Type5.Object({ scans: Type5.Array(ThreadCatalogScanSchema) }, { $id: "ThreadCatalogScansResult", additionalProperties: false });
var ExecNotificationSchema = Type5.Object({
  sessionId: Type5.Integer({ minimum: 0 }),
  customType: Type5.String({ minLength: 1 }),
  content: Type5.String({ minLength: 1 }),
  display: Type5.Boolean()
}, { $id: "ExecNotification", additionalProperties: false });
var PendingExecNotificationsResultSchema = Type5.Object({ notifications: Type5.Array(ExecNotificationSchema) }, { $id: "PendingExecNotificationsResult", additionalProperties: false });
var ExecNotificationClaimedSchema = Type5.Object({
  kind: Type5.Literal("claimed"),
  sessionId: Type5.Integer({ minimum: 0 }),
  customType: Type5.String({ minLength: 1 }),
  content: Type5.String({ minLength: 1 }),
  display: Type5.Boolean()
}, { $id: "ExecNotificationClaimed", additionalProperties: false });
var ExecNotificationUnavailableSchema = Type5.Object({ kind: Type5.Literal("unavailable") }, { $id: "ExecNotificationUnavailable", additionalProperties: false });
var ExecNotificationClaimSchema = Type5.Union([
  ExecNotificationClaimedSchema,
  ExecNotificationUnavailableSchema
]);
var ExecPolicyScopeSchema = Type5.Object({ scope: Type5.String({ minLength: 1 }), execPolicy: Type5.Unknown() }, { $id: "ExecPolicyScope", additionalProperties: false });
var RefreshExecPolicyFactsSchema = Type5.Object({ scopes: Type5.Array(ExecPolicyScopeSchema) }, { $id: "RefreshExecPolicyFacts", additionalProperties: false });
var RefreshExecPolicyResultSchema = Type5.Object({
  ok: Type5.Literal(true),
  activeRuleCount: Type5.Integer({ minimum: 0 }),
  scopes: Type5.Array(Type5.String()),
  errors: Type5.Array(Type5.String())
}, { $id: "RefreshExecPolicyResult", additionalProperties: false });
var SkillListFactsSchema = Type5.Object({ cwd: Type5.String(), includeDisabled: Type5.Optional(Type5.Boolean()) }, { $id: "SkillListFacts", additionalProperties: false });
var SkillInfoSchema = Type5.Object({
  name: Type5.String({ minLength: 1 }),
  location: Type5.String({ minLength: 1 }),
  baseDir: Type5.String(),
  description: Type5.String()
}, { $id: "SkillInfo", additionalProperties: false });
var SkillListResultSchema = Type5.Object({ skills: Type5.Array(SkillInfoSchema) }, { $id: "SkillListResult", additionalProperties: false });
var SkillResolveFactsSchema = Type5.Object({ prompt: Type5.String(), cwd: Type5.String(), ctx: Type5.Optional(Type5.Unknown()) }, { $id: "SkillResolveFacts", additionalProperties: false });
var SkillBlockSchema = Type5.Object({
  name: Type5.String({ minLength: 1 }),
  location: Type5.String({ minLength: 1 }),
  baseDir: Type5.String(),
  content: Type5.String({ minLength: 1 })
}, { $id: "SkillBlock", additionalProperties: false });
var BridgeWarningSchema = Type5.Object({ message: Type5.String({ minLength: 1 }) }, { $id: "BridgeWarning", additionalProperties: false });
var SkillResolveResultSchema = Type5.Object({ blocks: Type5.Array(SkillBlockSchema), warnings: Type5.Array(BridgeWarningSchema) }, { $id: "SkillResolveResult", additionalProperties: false });
var EnvironmentContextFactsSchema = Type5.Object({ shell: Type5.String() }, { $id: "EnvironmentContextFacts", additionalProperties: false });
var EnvironmentContextNoneSchema = Type5.Object({ kind: Type5.Literal("none") }, { $id: "EnvironmentContextNone", additionalProperties: false });
var EnvironmentContextInjectSchema = Type5.Object({
  kind: Type5.Literal("inject"),
  customType: Type5.String({ minLength: 1 }),
  content: Type5.String({ minLength: 1 }),
  display: Type5.Boolean()
}, { $id: "EnvironmentContextInject", additionalProperties: false });
var EnvironmentContextPlanSchema = Type5.Union([
  EnvironmentContextNoneSchema,
  EnvironmentContextInjectSchema
]);
var CommandNotificationFactsSchema = Type5.Object({
  commandName: Type5.String({ minLength: 1 }),
  ok: Type5.Boolean(),
  message: Type5.String(),
  error: Type5.String(),
  uiAvailable: Type5.Boolean()
}, { $id: "CommandNotificationFacts", additionalProperties: false });
var CommandNotificationUnavailableSchema = Type5.Object({ kind: Type5.Literal("unavailable") }, { $id: "CommandNotificationUnavailable", additionalProperties: false });
var CommandNotificationSendSchema = Type5.Object({
  kind: Type5.Literal("notify"),
  message: Type5.String({ minLength: 1 }),
  level: Type5.Union([Type5.Literal("info"), Type5.Literal("warning")])
}, { $id: "CommandNotificationSend", additionalProperties: false });
var CommandNotificationPlanSchema = Type5.Union([
  CommandNotificationUnavailableSchema,
  CommandNotificationSendSchema
]);
var PlanContinuationFactsSchema = Type5.Object({
  initial: Type5.Boolean(),
  hostIdle: Type5.Boolean(),
  hasPendingMessages: Type5.Boolean(),
  retrying: Type5.Boolean(),
  compacting: Type5.Boolean(),
  latestAssistantStopReason: Type5.Optional(Type5.String({ minLength: 1 })),
  ctx: Type5.Optional(Type5.Unknown())
}, { $id: "PlanContinuationFacts", additionalProperties: false });
var PlanContinuationNoneSchema = Type5.Object({ kind: Type5.Literal("none") }, { $id: "PlanContinuationNone", additionalProperties: false });
var PlanContinuationSendSchema = Type5.Object({
  kind: Type5.Literal("send"),
  customType: Type5.String({ minLength: 1 }),
  content: Type5.String({ minLength: 1 }),
  display: Type5.Boolean(),
  triggerTurn: Type5.Boolean(),
  deliverAs: Type5.String({ minLength: 1 }),
  details: PlanPresentationDetailsSchema
}, { $id: "PlanContinuationSend", additionalProperties: false });
var PlanContinuationPlanSchema = Type5.Union([
  PlanContinuationNoneSchema,
  PlanContinuationSendSchema
]);
var ChildPlanContinuationSendSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("send_plan_continuation"),
  customType: Type5.String({ minLength: 1 }),
  content: Type5.String({ minLength: 1 }),
  display: Type5.Boolean(),
  triggerTurn: Type5.Boolean(),
...
var ChildPlanContinuationFinalizeSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("finalize"),
  status: Type5.String({ minLength: 1 }),
  reason: Type5.Optional(Type5.String({ minLength: 1 }))
}, { $id: "ChildPlanContinuationFinalize", additionalProperties: false });
var ChildSessionStartFactsSchema = Type5.Object({
  metadata: ChildSessionMetadataSchema,
  parentSessionId: Type5.Optional(Type5.String()),
  parentSessionFile: Type5.Optional(Type5.String())
}, { $id: "ChildSessionStartFacts", additionalProperties: false });
var ChildSessionStartPlanSchema = Type5.Object({
  parentSession: Type5.Optional(Type5.String({ minLength: 1 })),
  modelId: Type5.Optional(Type5.String({ minLength: 1 })),
  thinkingLevel: Type5.Optional(Type5.String({ minLength: 1 })),
  activeTools: Type5.Optional(Type5.Array(Type5.String({ minLength: 1 }))),
  privateSessionDirectory: Type5.Optional(Type5.String({ minLength: 1 })),
  setupEntries: Type5.Array(ChildSessionSetupEntrySchema)
}, { $id: "ChildSessionStartPlan", additionalProperties: false });
var ChildDispatchFactsSchema = Type5.Object({
  available: Type5.Boolean(),
  cancelled: Type5.Optional(Type5.Boolean()),
  sessionId: Type5.Optional(Type5.String()),
  sessionFile: Type5.Optional(Type5.String()),
  error: Type5.Optional(Type5.String()),
  missingSessionIdentifier: Type5.Optional(Type5.Boolean()),
  activeTools: Type5.Optional(Type5.Array(Type5.String())),
  activeToolsApplied: Type5.Optional(Type5.Boolean()),
  modelId: Type5.Optional(Type5.String()),
  modelApplied: Type5.Optional(Type5.Boolean()),
  thinkingLevel: Type5.Optional(Type5.String()),
  thinkingApplied: Type5.Optional(Type5.Boolean()),
  prompt: Type5.String(),
  emptyReason: Type5.String({ minLength: 1 }),
  sendAvailable: Type5.Boolean(),
  deliverAs: Type5.Optional(Type5.String())
}, { $id: "ChildDispatchFacts", additionalProperties: false });
var ChildDispatchCompletionSchema = Type5.Object({
  status: Type5.Union([
    Type5.Literal("completed"),
    Type5.Literal("failed"),
    Type5.Literal("cancelled"),
    Type5.Literal("timed_out")
  ]),
  finalOutput: Type5.Optional(Type5.String()),
  reason: Type5.Optional(Type5.String())
}, { $id: "ChildDispatchCompletion", additionalProperties: false });
var ChildDispatchResultSchema = Type5.Object({
  dispatched: Type5.Boolean(),
  reason: Type5.Optional(Type5.String()),
  sessionId: Type5.Optional(Type5.String()),
  completion: Type5.Optional(ChildDispatchCompletionSchema)
}, { $id: "ChildDispatchResult", additionalProperties: false });
var ChildDispatchPlanSchema = Type5.Object({
  send: Type5.Boolean(),
  prompt: Type5.String(),
  deliverAs: Type5.String(),
  result: ChildDispatchResultSchema
}, { $id: "ChildDispatchPlan", additionalProperties: false });
var ResolvedMutationPathSchema = Type5.Object({ path: Type5.String({ minLength: 1 }), resolvedPath: Type5.String({ minLength: 1 }) }, { $id: "ResolvedMutationPath", additionalProperties: false });
var WorkspaceMutationFactsSchema = Type5.Object({
  workspaceRoots: Type5.Array(Type5.String({ minLength: 1 })),
  paths: Type5.Array(ResolvedMutationPathSchema)
}, { $id: "WorkspaceMutationFacts", additionalProperties: false });
var WorkspaceMutationValidSchema = Type5.Object({ kind: Type5.Literal("valid") }, { $id: "WorkspaceMutationValid", additionalProperties: false });
var WorkspaceMutationInvalidSchema = Type5.Object({ kind: Type5.Literal("invalid"), message: Type5.String({ minLength: 1 }) }, { $id: "WorkspaceMutationInvalid", additionalProperties: false });
var WorkspaceMutationValidationSchema = Type5.Union([
  WorkspaceMutationValidSchema,
  WorkspaceMutationInvalidSchema
]);
var ExecPolicyAllowRuleFactsSchema = Type5.Object({ tokens: Type5.Array(Type5.String({ minLength: 1 }), { minItems: 1 }) }, { $id: "ExecPolicyAllowRuleFacts", additionalProperties: false });
var ExecPolicyAllowRuleResultSchema = Type5.Object({ activeRuleCount: Type5.Integer({ minimum: 0 }) }, { $id: "ExecPolicyAllowRuleResult", additionalProperties: false });
var ExecApprovalPromptFactsSchema = Type5.Object({
  approvalTitle: Type5.String(),
  approvalPrompt: Type5.String(),
  approvalTimeoutMs: Type5.Number({ minimum: 0 }),
  uiAvailable: Type5.Boolean()
}, { $id: "ExecApprovalPromptFacts", additionalProperties: false });
var ExecApprovalUnavailableSchema = Type5.Object({ kind: Type5.Literal("unavailable") }, { $id: "ExecApprovalUnavailable", additionalProperties: false });
var ExecApprovalConfirmSchema = Type5.Object({
  kind: Type5.Literal("confirm"),
  title: Type5.String(),
  prompt: Type5.String(),
  timeoutMs: Type5.Optional(Type5.Number({ exclusiveMinimum: 0 }))
}, { $id: "ExecApprovalConfirm", additionalProperties: false });
var ExecApprovalPromptPlanSchema = Type5.Union([
  ExecApprovalUnavailableSchema,
  ExecApprovalConfirmSchema
]);
var CommandExecutionFactsSchema = Type5.Object({ name: Type5.String({ minLength: 1 }), args: Type5.String(), ctx: Type5.Optional(Type5.Unknown()) }, { $id: "CommandExecutionFacts", additionalProperties: false });
var CommandContextOverrideSchema = Type5.Object({ name: Type5.String({ minLength: 1 }), value: Type5.String() }, { $id: "CommandContextOverride", additionalProperties: false });
var CommandExecutionErrorSchema = Type5.Object({ kind: Type5.Literal("error"), message: Type5.String({ minLength: 1 }) }, { $id: "CommandExecutionError", additionalProperties: false });
var CommandExecutionDirectSchema = Type5.Object({ kind: Type5.Literal("direct") }, { $id: "CommandExecutionDirect", additionalProperties: false });
var CommandExecutionChildSchema = Type5.Object({
  kind: Type5.Literal("child"),
  metadata: ChildSessionMetadataSchema,
  contextOverrides: Type5.Array(CommandContextOverrideSchema),
  activeToolsMode: Type5.String({ minLength: 1 }),
  childSessionContextKey: Type5.String()
}, { $id: "CommandExecutionChild", additionalProperties: false });
var CommandExecutionPlanSchema = Type5.Union([
  CommandExecutionErrorSchema,
  CommandExecutionDirectSchema,
  CommandExecutionChildSchema
]);
var CommandChildSessionFactsSchema = Type5.Object({
  metadata: ChildSessionMetadataSchema,
  activeToolsMode: Type5.String({ minLength: 1 }),
  currentActiveToolsAvailable: Type5.Boolean(),
  currentActiveTools: Type5.Array(Type5.String({ minLength: 1 }))
}, { $id: "CommandChildSessionFacts", additionalProperties: false });
var CommandChildSessionPlanSchema = Type5.Object({ metadata: ChildSessionMetadataSchema }, { $id: "CommandChildSessionPlan", additionalProperties: false });
var BridgeToolResultSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("tool_result"),
  text: Type5.String(),
  details: Type5.Unknown()
}, { $id: "BridgeToolResult", additionalProperties: false });
var BridgeErrorResultSchema = Type5.Object({ ok: Type5.Literal(false), error: Type5.String({ minLength: 1 }) }, { $id: "BridgeErrorResult", additionalProperties: false });
var CoreAckSchema = Type5.Object({ ok: Type5.Literal(true) }, { $id: "CoreAck", additionalProperties: false });
var AgentOwnerContextFactsSchema = Type5.Object({ ctx: Type5.Unknown() }, { $id: "AgentOwnerContextFacts", additionalProperties: false });
var AgentActionCapabilityFactsSchema = Type5.Object({ capabilityId: Type5.String({ minLength: 1 }), agentId: Type5.String({ minLength: 1 }), action: Type5.String({ pattern: "^agent_(start|send|close)$" }), runId: Type5.Optional(Type5.String({ minLength: 1 })), submissionId: Type5.Optional(Type5.String({ minLength: 1 })), ctx: Type5.Unknown() }, { $id: "AgentActionCapabilityFacts", additionalProperties: false });
var ExecCompletionWaitResultSchema = Type5.Object({ ok: Type5.Literal(true), exited: Type5.Boolean() }, { $id: "ExecCompletionWaitResult", additionalProperties: false });
var BridgeToolExecutionResultSchema = Type5.Union([BridgeToolResultSchema, BridgeErrorResultSchema]);
var ExaExecutionFactsSchema = Type5.Object({ planId: Type5.String({ minLength: 1 }), ctx: Type5.Unknown() }, { $id: "ExaExecutionFacts", additionalProperties: false });
var ToolResultTextContentSchema = Type5.Object({ type: Type5.Literal("text"), text: Type5.String() }, { $id: "ToolResultTextContent", additionalProperties: false });
var ToolResultEnvelopeSchema = Type5.Object({ content: Type5.Array(ToolResultTextContentSchema, { minItems: 1 }), details: Type5.Unknown() }, { $id: "ToolResultEnvelope", additionalProperties: false });
var BridgeCommandResultSchema = Type5.Object({
  ok: Type5.Boolean(),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  details: Type5.Unknown()
}, { $id: "BridgeCommandResult", additionalProperties: false });
var ReadFileFactsSchema = Type5.Object({
  path: Type5.String({ minLength: 1 }),
  offset: Type5.Optional(Type5.Integer({ minimum: 1 })),
  limit: Type5.Optional(Type5.Integer({ minimum: 1 })),
  defaultCwd: Type5.String()
}, { $id: "ReadFileFacts", additionalProperties: false });
var ViewMediaFactsSchema = Type5.Object({ path: Type5.String({ minLength: 1 }), defaultCwd: Type5.String() }, { $id: "ViewMediaFacts", additionalProperties: false });
var ToolResultImageContentSchema = Type5.Object({
  type: Type5.Literal("image"),
  data: Type5.String({ minLength: 1 }),
  mimeType: Type5.String({ pattern: "^image/" })
}, { $id: "ToolResultImageContent", additionalProperties: false });
var ViewMediaSuccessEnvelopeSchema = Type5.Object({
  content: Type5.Tuple([ToolResultTextContentSchema, ToolResultImageContentSchema]),
  details: Type5.Unknown()
}, { $id: "ViewMediaSuccessEnvelope", additionalProperties: false });
var ViewMediaResultEnvelopeSchema = Type5.Union([
  ToolResultEnvelopeSchema,
  ViewMediaSuccessEnvelopeSchema
]);
var WriteStdinFactsSchema = Type5.Object({
  sessionId: Type5.Integer({ minimum: 1 }),
  chars: Type5.String(),
  outputMode: Type5.Optional(Type5.Union([Type5.Literal("delta"), Type5.Literal("status")])),
  yieldTimeMs: Type5.Optional(Type5.Number({ minimum: 0 })),
  maxOutputTokens: Type5.Optional(Type5.Integer({ minimum: 0 })),
  ownerId: Type5.String({ minLength: 1 }),
  signal: Type5.Optional(Type5.Unknown())
}, { $id: "WriteStdinFacts", additionalProperties: false });
var ExecTruncationSchema = Type5.Object({
  truncated: Type5.Boolean(),
  truncatedBy: Type5.String(),
  totalLines: Type5.Integer(),
  totalBytes: Type5.Integer(),
  outputLines: Type5.Integer(),
  outputBytes: Type5.Integer(),
  maxLines: Type5.Integer(),
  maxBytes: Type5.Integer(),
  lastLinePartial: Type5.Boolean(),
  firstLineExceedsLimit: Type5.Boolean(),
  fullOutputPath: Type5.Optional(Type5.String())
}, { $id: "ExecTruncation", additionalProperties: false });
var ExecResultDetailsSchema = Type5.Object({
  ok: Type5.Boolean(),
  output: Type5.String(),
  stdout: Type5.String(),
  stderr: Type5.String(),
  truncation: ExecTruncationSchema,
  wallTimeMs: Type5.Number(),
  outputMode: Type5.String(),
  suppressedLines: Type5.Integer(),
  suppressedBytes: Type5.Integer(),
  reasonCode: Type5.Optional(Type5.String()),
  outputLimitBytes: Type5.Optional(Type5.Number()),
  truncated: Type5.Optional(Type5.Boolean()),
  fullOutputPath: Type5.Optional(Type5.String()),
  exitCode: Type5.Optional(Type5.Integer()),
  code: Type5.Optional(Type5.Integer()),
  sessionId: Type5.Optional(Type5.Integer()),
  session_id: Type5.Optional(Type5.Integer()),
  sandboxed: Type5.Optional(Type5.Boolean()),
  escalated: Type5.Optional(Type5.Boolean()),
  kind: Type5.Optional(Type5.String()),
  alreadyCompleted: Type5.Optional(Type5.Boolean())
}, { $id: "ExecResultDetails", additionalProperties: false });
var HostExecResultSchema = Type5.Object({ code: Type5.Integer(), stdout: Type5.String(), stderr: Type5.String() }, { $id: "HostExecResult", additionalProperties: false });
var ExecToolResultSchema = Type5.Object({ content: Type5.Array(ToolResultTextContentSchema, { minItems: 1 }), details: ExecResultDetailsSchema }, { $id: "ExecToolResult", additionalProperties: false });
var ExecApprovalOutcomeFactsSchema = Type5.Object({
  planId: Type5.String({ minLength: 1 }),
  ctx: Type5.Unknown(),
  outcome: Type5.Union([
    Type5.Literal("approved"),
    Type5.Literal("denied_by_user"),
    Type5.Literal("timed_out"),
    Type5.Literal("unavailable"),
    Type5.Literal("interrupted")
  ])
}, { $id: "ExecApprovalOutcomeFacts", additionalProperties: false });
var ExecApprovalRunSchema = Type5.Object({ kind: Type5.Literal("run"), forceUnsandboxed: Type5.Literal(true) }, { $id: "ExecApprovalRun", additionalProperties: false });
var ExecApprovalDeniedSchema = Type5.Object({ kind: Type5.Literal("denied"), result: ToolResultEnvelopeSchema }, { $id: "ExecApprovalDenied", additionalProperties: false });
var ExecApprovalResultSchema = Type5.Union([ExecApprovalRunSchema, ExecApprovalDeniedSchema]);
var AuthorityPlanRefSchema = Type5.Object({ planId: Type5.String({ minLength: 1 }), ctx: Type5.Unknown() }, { $id: "AuthorityPlanRef", additionalProperties: false });
var AuthorityPlanIssuedSchema = Type5.Object({ planId: Type5.String({ minLength: 1 }) }, { $id: "AuthorityPlanIssued", additionalProperties: false });
var CommandChildDispatchFactsSchema = Type5.Object({ result: BridgeCommandResultSchema, bridge: Type5.Unknown() }, { $id: "CommandChildDispatchFacts", additionalProperties: false });
var CommandBridgeUpdateSchema = Type5.Object({ action: Type5.String({ minLength: 1 }), key: Type5.String({ minLength: 1 }) }, { $id: "CommandBridgeUpdate", additionalProperties: false });
var CommandChildReturnSchema = Type5.Object({ kind: Type5.Literal("return"), result: BridgeCommandResultSchema }, { $id: "CommandChildReturn", additionalProperties: false });
var CommandChildDispatchSchema = Type5.Object({
  kind: Type5.Literal("dispatch"),
  result: BridgeCommandResultSchema,
  bridgeUpdate: CommandBridgeUpdateSchema,
  prompt: Type5.String({ minLength: 1 })
}, { $id: "CommandChildDispatch", additionalProperties: false });
var CommandChildDispatchPlanSchema = Type5.Union([CommandChildReturnSchema, CommandChildDispatchSchema]);
var CommandChildDispatchFinishFactsSchema = Type5.Object({ result: BridgeCommandResultSchema, dispatch: ChildDispatchResultSchema }, { $id: "CommandChildDispatchFinishFacts", additionalProperties: false });
var CronContextFactsSchema = Type5.Object({ ctx: Type5.Unknown() }, { $id: "CronContextFacts", additionalProperties: false });
var CronPlanFactsSchema = Type5.Object({ planSlotFree: Type5.Boolean(), planDriving: Type5.Boolean() }, { $id: "CronPlanFacts", additionalProperties: false });
var CronPollFactsSchema = Type5.Object({
  now: Type5.Number(),
  hostIdle: Type5.Boolean(),
  planDriving: Type5.Boolean(),
  planSlotFree: Type5.Boolean(),
  ctx: Type5.Unknown()
}, { $id: "CronPollFacts", additionalProperties: false });
var CronPollNoneSchema = Type5.Object({ kind: Type5.Literal("none") }, { $id: "CronPollNone", additionalProperties: false });
var CronPollDeliverySchema = Type5.Object({
  kind: Type5.Literal("deliver"),
  id: Type5.String({ minLength: 1 }),
  mode: Type5.Union([Type5.Literal("message"), Type5.Literal("plan")]),
  content: Type5.String({ minLength: 1 }),
  coalesced: Type5.Integer({ minimum: 1 }),
  cron: Type5.String({ minLength: 1 }),
  schedule: Type5.String()
}, { $id: "CronPollDelivery", additionalProperties: false });
var CronPollPlanSchema = Type5.Union([CronPollNoneSchema, CronPollDeliverySchema]);
var CronDeliveredFactsSchema = Type5.Object({ id: Type5.String({ minLength: 1 }), now: Type5.Number(), ctx: Type5.Unknown() }, { $id: "CronDeliveredFacts", additionalProperties: false });
var CronDeliveredResultSchema = Type5.Object({ acknowledged: Type5.Boolean() }, { $id: "CronDeliveredResult", additionalProperties: false });
var CronStartupFactsSchema = Type5.Object({ reason: Type5.String(), ctx: Type5.Unknown() }, { $id: "CronStartupFacts", additionalProperties: false });
var CronStartupNoneSchema = Type5.Object({ kind: Type5.Literal("none") }, { $id: "CronStartupNone", additionalProperties: false });
var CronStartupNotifySchema = Type5.Object({ kind: Type5.Literal("notify"), message: Type5.String({ minLength: 1 }) }, { $id: "CronStartupNotify", additionalProperties: false });
var CronStartupPlanSchema = Type5.Union([CronStartupNoneSchema, CronStartupNotifySchema]);
var ThreadToolFactsSchema = Type5.Object({
  name: Type5.Union([Type5.Literal("query_threads"), Type5.Literal("read_thread")]),
  params: Type5.Unknown(),
  catalog: Type5.Unknown(),
  ctx: Type5.Unknown()
}, { $id: "ThreadToolFacts", additionalProperties: false });
var PlanRollbackFactsSchema = Type5.Object({ snapshot: Type5.Unknown(), ctx: Type5.Unknown() }, { $id: "PlanRollbackFacts", additionalProperties: false });
var FinalizePlanErrorFactsSchema = Type5.Object({ status: Type5.String({ minLength: 1 }), ctx: Type5.Unknown() }, { $id: "FinalizePlanErrorFacts", additionalProperties: false });
var PlanRollbackResultSchema = Type5.Object({ completed: Type5.Literal(true) }, { $id: "PlanRollbackResult", additionalProperties: false });
var MutationErrorSchema = Type5.Object({ kind: Type5.Literal("error"), message: Type5.String({ minLength: 1 }) }, { $id: "MutationError", additionalProperties: false });
var EditApplicationFactsSchema = Type5.Object({ path: Type5.String({ minLength: 1 }), displayPath: Type5.String({ minLength: 1 }), edits: Type5.Array(EditReplacementSchema, { minItems: 1 }), contents: Type5.String() }, { $id: "EditApplicationFacts", additionalProperties: false });
var EditAppliedSchema = Type5.Object({
  kind: Type5.Literal("applied"),
  path: Type5.String({ minLength: 1 }),
  displayPath: Type5.String({ minLength: 1 }),
  contents: Type5.String(),
  editCount: Type5.Integer({ minimum: 1 })
}, { $id: "EditApplied", additionalProperties: false });
var EditApplicationResultSchema = Type5.Union([MutationErrorSchema, EditAppliedSchema]);
var PatchWriteSchema = Type5.Object({ path: Type5.String({ minLength: 1 }), contents: Type5.String() }, { $id: "PatchWrite", additionalProperties: false });
var AuthorizedMutationPathSchema = Type5.Object({ originalPath: Type5.String({ minLength: 1 }), resolvedPath: Type5.String({ minLength: 1 }) }, { $id: "AuthorizedMutationPath", additionalProperties: false });
var PatchApplicationFactsSchema = Type5.Object({
  params: ApplyPatchParamsSchema,
  files: Type5.Record(Type5.String(), Type5.String()),
  ctx: Type5.Unknown(),
  filesystemApproval: Type5.Boolean(),
  authorizedPaths: Type5.Array(AuthorizedMutationPathSchema, { minItems: 1 })
}, { $id: "PatchApplicationFacts", additionalProperties: false });
var PatchAppliedSchema = Type5.Object({
  kind: Type5.Literal("applied"),
  deletes: Type5.Array(Type5.String({ minLength: 1 })),
  writes: Type5.Array(PatchWriteSchema),
  affectedPaths: Type5.Array(Type5.String({ minLength: 1 }))
}, { $id: "PatchApplied", additionalProperties: false });
var PatchApplicationResultSchema = Type5.Union([MutationErrorSchema, PatchAppliedSchema]);
var VisibilityWarningFactsSchema = Type5.Object({
  tools: Type5.Array(Type5.String({ minLength: 1 })),
  skills: Type5.Array(Type5.String({ minLength: 1 }))
}, { $id: "VisibilityWarningFacts", additionalProperties: false });
var VisibilityWarningsResultSchema = Type5.Object({ messages: Type5.Array(Type5.String({ minLength: 1 })) }, { $id: "VisibilityWarningsResult", additionalProperties: false });
var VisibilityRowsFactsSchema = Type5.Object({
  category: Type5.Union([Type5.Literal("tools"), Type5.Literal("skills")]),
  ctx: Type5.Unknown()
}, { $id: "VisibilityRowsFacts", additionalProperties: false });
var VisibilityRowSchema = Type5.Object({
  name: Type5.String({ minLength: 1 }),
  state: Type5.String({ minLength: 1 }),
  available: Type5.Boolean(),
  description: Type5.String()
}, { $id: "VisibilityRow", additionalProperties: false });
var VisibilityRowsResultSchema = Type5.Object({
  category: Type5.Union([Type5.Literal("tools"), Type5.Literal("skills")]),
  title: Type5.String({ minLength: 1 }),
  rows: Type5.Array(VisibilityRowSchema),
  disabled: Type5.Array(Type5.String({ minLength: 1 })),
  unavailable: Type5.Array(Type5.String({ minLength: 1 }))
}, { $id: "VisibilityRowsResult", additionalProperties: false });
var VisibilityToggleFactsSchema = Type5.Object({
  category: Type5.Union([Type5.Literal("tools"), Type5.Literal("skills")]),
  name: Type5.String({ minLength: 1 }),
  ctx: Type5.Unknown()
}, { $id: "VisibilityToggleFacts", additionalProperties: false });
var VisibilityMutationDetailsSchema = Type5.Object({
  category: Type5.Union([Type5.Literal("tools"), Type5.Literal("skills")]),
  title: Type5.String({ minLength: 1 }),
  rows: Type5.Array(VisibilityRowSchema),
  disabled: Type5.Array(Type5.String({ minLength: 1 })),
  unavailable: Type5.Array(Type5.String({ minLength: 1 })),
  visibilityChanged: Type5.Literal(true),
  enabledName: Type5.Optional(Type5.String({ minLength: 1 })),
  disabledName: Type5.Optional(Type5.String({ minLength: 1 }))
}, { $id: "VisibilityMutationDetails", additionalProperties: false });
var VisibilityToggleSuccessSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  details: VisibilityMutationDetailsSchema
}, { $id: "VisibilityToggleSuccess", additionalProperties: false });
var VisibilityToggleErrorSchema = Type5.Object({
  ok: Type5.Literal(false),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  error: Type5.String({ minLength: 1 }),
  details: VisibilityRowsResultSchema
}, { $id: "VisibilityToggleError", additionalProperties: false });
var VisibilityToggleResultSchema = Type5.Union([VisibilityToggleSuccessSchema, VisibilityToggleErrorSchema]);
var VisibilitySavePlanSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("visibility_save_project"),
  category: Type5.Union([Type5.Literal("tools"), Type5.Literal("skills")]),
  disabled: Type5.Array(Type5.String({ minLength: 1 })),
  details: VisibilityRowsResultSchema
}, { $id: "VisibilitySavePlan", additionalProperties: false });
var VisibilityListResultSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  details: VisibilityRowsResultSchema
}, { $id: "VisibilityListResult", additionalProperties: false });
var CompactionSettingsSchema = Type5.Object({
  session: Type5.Optional(Type5.String()),
  global: Type5.Optional(Type5.String()),
  project: Type5.Optional(Type5.String())
}, { $id: "CompactionSettings", additionalProperties: false });
var CompactionCommandFactsSchema = Type5.Object({ args: Type5.String(), settings: CompactionSettingsSchema }, { $id: "CompactionCommandFacts", additionalProperties: false });
var CompactionPlanErrorSchema = Type5.Object({ kind: Type5.Literal("error"), message: Type5.String({ minLength: 1 }) }, { $id: "CompactionPlanError", additionalProperties: false });
var CompactionShowSchema = Type5.Object({ kind: Type5.Literal("show"), model: Type5.String(), source: Type5.String({ minLength: 1 }) }, { $id: "CompactionShow", additionalProperties: false });
var CompactionSetProjectSchema = Type5.Object({ kind: Type5.Literal("set_project"), model: Type5.String({ minLength: 1 }) }, { $id: "CompactionSetProject", additionalProperties: false });
var CompactionClearProjectSchema = Type5.Object({ kind: Type5.Literal("clear_project") }, { $id: "CompactionClearProject", additionalProperties: false });
var CompactionOpenPickerSchema = Type5.Object({ kind: Type5.Literal("open_picker"), current: Type5.String() }, { $id: "CompactionOpenPicker", additionalProperties: false });
var CompactionCommandPlanSchema = Type5.Union([
...
var CompactionDefaultSchema = Type5.Object({ kind: Type5.Literal("default") }, { $id: "CompactionDefault", additionalProperties: false });
var CompactionUseModelSchema = Type5.Object({ kind: Type5.Literal("compact"), model: Type5.String({ minLength: 1 }) }, { $id: "CompactionUseModel", additionalProperties: false });
var CompactionSessionPlanSchema = Type5.Union([CompactionDefaultSchema, CompactionUseModelSchema]);
var PermissionsMenuOptionSchema = Type5.Object({
  label: Type5.String({ minLength: 1 }),
  value: Type5.String({ minLength: 1 }),
  description: Type5.String(),
  selected: Type5.Boolean()
}, { $id: "PermissionsMenuOption", additionalProperties: false });
var PermissionsPromptSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("permissions_prompt"),
  title: Type5.String({ minLength: 1 }),
  message: Type5.String(),
  options: Type5.Array(PermissionsMenuOptionSchema)
}, { $id: "PermissionsPrompt", additionalProperties: false });
var PermissionsPromptFactsSchema = Type5.Object({ prompt: PermissionsPromptSchema, uiAvailable: Type5.Boolean() }, { $id: "PermissionsPromptFacts", additionalProperties: false });
var PermissionsCommandResultSchema = Type5.Object({
  ok: Type5.Boolean(),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  error: Type5.Optional(Type5.String()),
  details: Type5.Optional(Type5.Unknown())
}, { $id: "PermissionsCommandResult", additionalProperties: false });
var PermissionsPromptSelectSchema = Type5.Object({
  kind: Type5.Literal("select"),
  title: Type5.String({ minLength: 1 }),
  labels: Type5.Array(Type5.String({ minLength: 1 }), { minItems: 1 })
}, { $id: "PermissionsPromptSelect", additionalProperties: false });
var PermissionsPromptResultSchema = Type5.Object({ kind: Type5.Literal("result"), result: PermissionsCommandResultSchema }, { $id: "PermissionsPromptResult", additionalProperties: false });
var PermissionsPromptPlanSchema = Type5.Union([PermissionsPromptSelectSchema, PermissionsPromptResultSchema]);
var PermissionsSelectionSchema = Type5.Object({
  status: Type5.Union([Type5.Literal("selected"), Type5.Literal("cancelled")]),
  selected: Type5.Optional(Type5.String())
}, { $id: "PermissionsSelection", additionalProperties: false });
var PermissionsPromptFinishFactsSchema = Type5.Object({ prompt: PermissionsPromptSchema, selection: PermissionsSelectionSchema, ctx: Type5.Unknown() }, { $id: "PermissionsPromptFinishFacts", additionalProperties: false });
var CronTaskSchema2 = Type5.Object({
  id: Type5.String({ minLength: 1 }),
  schedule: Type5.String(),
  cron: Type5.String({ minLength: 1 }),
  prompt: Type5.String(),
  recurring: Type5.Boolean(),
  mode: Type5.Union([Type5.Literal("message"), Type5.Literal("plan")]),
  enabled: Type5.Boolean(),
  nextDue: Type5.Integer(),
  nextDueText: Type5.String(),
  pending: Type5.Boolean()
}, { $id: "CronTask", additionalProperties: false });
var CronListDetailsSchema = Type5.Object({ enabled: Type5.Boolean(), tasks: Type5.Array(CronTaskSchema2) }, { $id: "CronListDetails", additionalProperties: false });
var CronListResultSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("tool_result"),
  text: Type5.String(),
  details: CronListDetailsSchema
}, { $id: "CronListResult", additionalProperties: false });
var CronTaskPatchSchema = Type5.Object({
  id: Type5.String({ minLength: 1 }),
  prompt: Type5.Optional(Type5.String()),
  cron: Type5.Optional(Type5.String({ minLength: 1 })),
  recurring: Type5.Optional(Type5.Boolean()),
  mode: Type5.Optional(Type5.Union([Type5.Literal("message"), Type5.Literal("plan")]))
}, { $id: "CronTaskPatch", additionalProperties: false });
var CronTaskUpdateFactsSchema = Type5.Object({ patch: CronTaskPatchSchema, ctx: Type5.Unknown() }, { $id: "CronTaskUpdateFacts", additionalProperties: false });
var CronManagerCommandFactsSchema = Type5.Object({ args: Type5.String(), ctx: Type5.Unknown() }, { $id: "CronManagerCommandFacts", additionalProperties: false });
var CronCommandResultSchema = Type5.Object({
  ok: Type5.Boolean(),
  action: Type5.Literal("command_result"),
  message: Type5.String(),
  details: Type5.Unknown(),
...
var CronPromptSchema = Type5.Object({
  ok: Type5.Literal(true),
  action: Type5.Literal("cron_prompt"),
  enabled: Type5.Boolean(),
  tasks: Type5.Array(CronTaskSchema2)
}, { $id: "CronPrompt", additionalProperties: false });
var CronPromptFactsSchema = Type5.Object({ prompt: CronPromptSchema, uiAvailable: Type5.Boolean() }, { $id: "CronPromptFacts", additionalProperties: false });
var CronPromptPlanSchema = Type5.Object({ kind: Type5.Literal("result"), result: CronCommandResultSchema }, { $id: "CronPromptPlan", additionalProperties: false });
...
var ComposerSettingsSchema = Type6.Object({
  taumel: Type6.Object({ composer: Type6.Object({ enabled: Type6.Boolean() }, { additionalProperties: false }) }, { additionalProperties: false })
}, { $id: "ComposerSettings", additionalProperties: false });
var ComposerCommandFactsSchema = Type6.Object({
  args: Type6.String(),
  path: Type6.String({ minLength: 1 }),
  settings: ComposerSettingsSchema
}, { $id: "ComposerCommandFacts", additionalProperties: false });
var ComposerCommandErrorSchema = Type6.Object({ kind: Type6.Literal("error"), message: Type6.String({ minLength: 1 }) }, { $id: "ComposerCommandError", additionalProperties: false });
var ComposerCommandSuccessSchema = Type6.Object({
  kind: Type6.Literal("result"),
  message: Type6.String(),
  settings: ComposerSettingsSchema,
  writeSettings: Type6.Boolean()
}, { $id: "ComposerCommandSuccess", additionalProperties: false });
var ComposerCommandResultSchema = Type6.Union([ComposerCommandErrorSchema, ComposerCommandSuccessSchema]);
var CronPlanCreationFactsSchema = Type6.Object({ title: Type6.String({ minLength: 1 }), ctx: Type6.Unknown() }, { $id: "CronPlanCreationFacts", additionalProperties: false });
var CronPlanCreationResultSchema = Type6.Object({ created: Type6.Boolean() }, { $id: "CronPlanCreationResult", additionalProperties: false });
var HandleCommandFactsSchema = Type6.Object({ name: Type6.String({ minLength: 1 }), args: Type6.String(), ctx: Type6.Unknown() }, { $id: "HandleCommandFacts", additionalProperties: false });
var GatewayCommandErrorSchema = Type6.Object({ ok: Type6.Literal(false), error: Type6.String({ minLength: 1 }) }, { $id: "GatewayCommandError", additionalProperties: false });
var GatewayCommandResultSchema = Type6.Object({
  ok: Type6.Boolean(),
  action: Type6.Literal("command_result"),
  message: Type6.String(),
  error: Type6.Optional(Type6.String()),
  details: Type6.Optional(Type6.Unknown()),
  planFollowup: Type6.Optional(Type6.Boolean()),
  planSubmitUserMessage: Type6.Optional(Type6.String()),
  planRollback: Type6.Optional(Type6.Unknown()),
  planInspection: Type6.Optional(Type6.Boolean())
}, { $id: "GatewayCommandResult", additionalProperties: false });
var VisibilityPromptSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("visibility_prompt"),
  category: Type6.Union([Type6.Literal("tools"), Type6.Literal("skills")]),
  title: Type6.String({ minLength: 1 })
}, { $id: "VisibilityPrompt", additionalProperties: false });
var OpenAiUsageFetchSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("openai_usage_fetch"), apiKeyPresent: Type6.Boolean() }, { $id: "OpenAiUsageFetch", additionalProperties: false });
var UsagePairFetchSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("usage_pair_fetch"),
  openaiApiKeyPresent: Type6.Boolean()
}, { $id: "UsagePairFetch", additionalProperties: false });
var GatewayCommandOutputSchema = Type6.Union([
...
var PrepareToolFactsSchema = Type6.Object({ name: Type6.String({ minLength: 1 }), params: Type6.Unknown(), ctx: Type6.Unknown() }, { $id: "PrepareToolFacts", additionalProperties: false });
var SandboxConfigSchema = Type6.Object({
  filesystemMode: Type6.Union([
    Type6.Literal("read-only"),
    Type6.Literal("workspace-write"),
    Type6.Literal("danger-full-access")
  ]),
  networkMode: Type6.Union([Type6.Literal("disabled"), Type6.Literal("enabled")]),
  workspaceRoots: Type6.Array(Type6.String({ minLength: 1 })),
  noSandbox: Type6.Boolean(),
  isolatedChild: Type6.Boolean(),
  approvalPolicy: Type6.Union([
    Type6.Literal("never"),
    Type6.Literal("on-request"),
    Type6.Literal("on-failure"),
    Type6.Literal("untrusted")
  ])
}, { $id: "SandboxConfig", additionalProperties: false });
var ExecHostOptionsSchema = Type6.Object({
  cwd: Type6.String(),
  timeout: Type6.Optional(Type6.Number({ minimum: 0 })),
  yieldTimeMs: Type6.Optional(Type6.Number({ minimum: 0 })),
  tty: Type6.Optional(Type6.Boolean())
}, { $id: "ExecHostOptions", additionalProperties: false });
var ExecHostCallSchema = Type6.Object({
  ok: Type6.Literal(true),
  command: Type6.String({ minLength: 1 }),
  args: Type6.Array(Type6.String()),
  options: ExecHostOptionsSchema,
  sandboxed: Type6.Boolean(),
  escalated: Type6.Boolean()
}, { $id: "ExecHostCall", additionalProperties: false });
var WriteStdinHostOptionsSchema = Type6.Object({ yieldTimeMs: Type6.Optional(Type6.Number({ minimum: 0 })) }, { $id: "WriteStdinHostOptions", additionalProperties: false });
var WriteStdinHostResultSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("result"), result: ToolResultEnvelopeSchema }, { $id: "WriteStdinHostResult", additionalProperties: false });
var WriteStdinHostCallSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("call"),
  sessionId: Type6.Integer({ minimum: 1 }),
  chars: Type6.String(),
  options: WriteStdinHostOptionsSchema
}, { $id: "WriteStdinHostCall", additionalProperties: false });
var approvalFields = {
  approvalTitle: Type6.String({ minLength: 1 }),
  approvalPrompt: Type6.String({ minLength: 1 }),
  approvalTimeoutMs: Type6.Number({ minimum: 0 })
};
var PreparedReadSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("read"), path: Type6.String({ minLength: 1 }), offset: Type6.Optional(Type6.Integer()), limit: Type6.Optional(Type6.Integer({ minimum: 1 })) }, { $id: "PreparedRead", additionalProperties: false });
var PreparedViewMediaSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("view_media"), path: Type6.String({ minLength: 1 }) }, { $id: "PreparedViewMedia", additionalProperties: false });
var PreparedWriteStdinSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("write_stdin"), sessionId: Type6.Integer({ minimum: 1 }), chars: Type6.String(), yieldTimeMs: Type6.Optional(Type6.Number({ minimum: 0 })), maxOutputTokens: Type6.Optional(Type6.Integer({ minimum: 0 })), outputMode: Type6.Union([Type6.Literal("delta"), Type6.Literal("status")]) }, { $id: "PreparedWriteStdin", additionalProperties: false });
var PreparedExecSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("exec_command"),
  planId: Type6.String({ minLength: 1 }),
  cmd: Type6.String({ minLength: 1 }),
  workdir: Type6.String(),
  yieldTimeMs: Type6.Optional(Type6.Number({ minimum: 0 })),
  maxOutputTokens: Type6.Optional(Type6.Integer({ minimum: 0 })),
  tty: Type6.Boolean(),
  sandbox: SandboxConfigSchema,
  brokeredGit: Type6.Optional(Type6.Boolean())
}, { $id: "PreparedExec", additionalProperties: false });
var PreparedExecApprovalSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("exec_command_approval"),
  planId: Type6.String({ minLength: 1 }),
  cmd: Type6.String({ minLength: 1 }),
  workdir: Type6.String(),
  yieldTimeMs: Type6.Optional(Type6.Number({ minimum: 0 })),
  ...
  tty: Type6.Boolean(),
  sandbox: SandboxConfigSchema,
  approvalMessage: Type6.String(),
  ...approvalFields,
  execPolicyAllowAlwaysTokens: Type6.Optional(Type6.Array(Type6.String({ minLength: 1 })))
}, { $id: "PreparedExecApproval", additionalProperties: false });
var PreparedExecInputSchema = Type6.Union([PreparedExecSchema, PreparedExecApprovalSchema], { $id: "PreparedExecInput" });
var mutationBase = {
  ok: Type6.Literal(true),
  workspaceRoots: Type6.Array(Type6.String({ minLength: 1 })),
  validateWorkspacePaths: Type6.Boolean(),
  path: Type6.String({ minLength: 1 }),
  displayPath: Type6.String({ minLength: 1 })
};
var WriteModeSchema = Type6.Union([Type6.Literal("overwrite"), Type6.Literal("append")]);
var PreparedWriteSchema = Type6.Object({ ...mutationBase, action: Type6.Literal("write"), contents: Type6.String(), mode: WriteModeSchema, filesystemApproval: Type6.Optional(Type6.Boolean()) }, { $id: "PreparedWrite", additionalProperties: false });
var PreparedWriteApprovalSchema = Type6.Object({ ...mutationBase, action: Type6.Literal("write_approval"), contents: Type6.String(), mode: WriteModeSchema, approvalAction: Type6.Literal("write"), ...approvalFields }, { $id: "PreparedWriteApproval", additionalProperties: false });
var PreparedEditSchema = Type6.Object({ ...mutationBase, action: Type6.Literal("edit"), edits: Type6.Array(EditReplacementSchema, { minItems: 1 }), filesystemApproval: Type6.Optional(Type6.Boolean()) }, { $id: "PreparedEdit", additionalProperties: false });
var PreparedEditApprovalSchema = Type6.Object({ ...mutationBase, action: Type6.Literal("edit_approval"), edits: Type6.Array(EditReplacementSchema, { minItems: 1 }), approvalAction: Type6.Literal("edit"), ...approvalFields }, { $id: "PreparedEditApproval", additionalProperties: false });
var authorizedPatchPaths = { authorizedPaths: Type6.Array(AuthorizedMutationPathSchema, { minItems: 1 }) };
var PreparedPatchSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("apply_patch"), workspaceRoots: Type6.Array(Type6.String({ minLength: 1 })), validateWorkspacePaths: Type6.Boolean(), affectedPaths: Type6.Array(Type6.String({ minLength: 1 })), ...authorizedPatchPaths, patch: Type6.String(), filesystemApproval: Type6.Optional(Type6.Boolean()) }, { $id: "PreparedPatch", additionalProperties: false });
var PreparedPatchApprovalSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("apply_patch_approval"), workspaceRoots: Type6.Array(Type6.String({ minLength: 1 })), validateWorkspacePaths: Type6.Boolean(), affectedPaths: Type6.Array(Type6.String({ minLength: 1 })), ...authorizedPatchPaths, patch: Type6.String(), approvalAction: Type6.Literal("apply_patch"), ...approvalFields }, { $id: "PreparedPatchApproval", additionalProperties: false });
var PreparedThreadQuerySchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("query_threads"), query: Type6.String({ minLength: 1, maxLength: 500 }), limit: Type6.Integer({ minimum: 1, maximum: 50 }), scope: Type6.Union([Type6.Literal("current_workspace"), Type6.Literal("all")]), includeTools: Type6.Boolean() }, { $id: "PreparedThreadQuery", additionalProperties: false });
var PreparedThreadLocatorSchema = Type6.Object({
  threadID: Type6.String({ minLength: 1 }),
  sourcePath: Type6.Optional(Type6.String({ minLength: 1 })),
  entryID: Type6.Optional(Type6.String({ minLength: 1 })),
  line: Type6.Optional(Type6.Integer({ minimum: 1 }))
}, { $id: "PreparedThreadLocator", additionalProperties: false });
var PreparedThreadReadSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("read_thread"),
  threadID: Type6.String({ minLength: 1 }),
  mode: Type6.Union([Type6.Literal("overview"), Type6.Literal("window"), Type6.Literal("full")]),
  around: Type6.Integer({ minimum: 0, maximum: 10 }),
  entryID: Type6.Optional(Type6.String({ minLength: 1 })),
  line: Type6.Optional(Type6.Integer({ minimum: 1 })),
  cursor: Type6.Optional(Type6.String({ minLength: 1 })),
  locator: Type6.Optional(PreparedThreadLocatorSchema)
}, { $id: "PreparedThreadRead", additionalProperties: false });
var PreparedExaSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("exa_fetch"), planId: Type6.String({ minLength: 1 }), toolName: Type6.String({ minLength: 1 }) }, { $id: "PreparedExa", additionalProperties: false });
var PreparedExaApprovalSchema = Type6.Object({ ok: Type6.Literal(true), action: Type6.Literal("exa_agent_create_run_approval"), planId: Type6.String({ minLength: 1 }), toolName: Type6.String({ minLength: 1 }), ...approvalFields }, { $id: "PreparedExaApproval", additionalProperties: false });
var AgentKindSchema = Type6.Union([
  Type6.Literal("generic"),
  Type6.Literal("finder"),
  Type6.Literal("oracle")
]);
var AgentRunStatusSchema = Type6.Union([
  Type6.Literal("running"),
  Type6.Literal("suspended"),
  Type6.Literal("completed"),
  Type6.Literal("failed"),
  Type6.Literal("cancelled"),
  Type6.Literal("lost")
]);
var AgentSendOutcomeSchema = Type6.Union([
  Type6.Literal("message_sent"),
  Type6.Literal("interrupted_and_sent"),
  Type6.Literal("suspended"),
  Type6.Literal("already_suspended"),
  Type6.Literal("resumed"),
  Type6.Literal("started"),
  Type6.Literal("no_active_run")
]);
var AgentReasonCodeSchema = Type6.Union([
  Type6.Literal("interrupted_by_parent"),
  Type6.Literal("parent_shutdown"),
  Type6.Literal("process_interrupted"),
  Type6.Literal("close_cleanup_failed"),
  Type6.Literal("host_cancelled"),
  Type6.Literal("dispatch_failed"),
  Type6.Literal("agent_failed"),
  Type6.Literal("internal_error"),
  Type6.Literal("child_session_lost")
]);
var AgentSuspensionReasonCodeSchema = Type6.Union([
  Type6.Literal("interrupted_by_parent"),
  Type6.Literal("parent_shutdown"),
  Type6.Literal("process_interrupted"),
  Type6.Literal("close_cleanup_failed")
]);
var AgentStartDetailsSchema = Type6.Object({
  ok: Type6.Literal(true),
  runId: Type6.String({ minLength: 1 }),
  kind: AgentKindSchema,
  model: Type6.String({ minLength: 1 }),
  thinking: Type6.String({ minLength: 1 }),
  status: Type6.Literal("running"),
  prompt: Type6.String(),
  agentId: Type6.String({ minLength: 1 }),
  activeTools: Type6.Array(Type6.String({ minLength: 1 })),
  workspace: Type6.String({ minLength: 1 }),
  isolation: Type6.Union([Type6.Literal("none"), Type6.Literal("worktree")]),
  tier: Type6.Optional(Type6.Union([Type6.Literal("low"), Type6.Literal("medium"), Type6.Literal("high")]))
}, { $id: "AgentStartDetails", additionalProperties: false });
var AgentSendDetailsSchema = Type6.Object({
  agentId: Type6.String({ minLength: 1 }),
  outcome: AgentSendOutcomeSchema,
  runId: Type6.Optional(Type6.String({ minLength: 1 })),
  status: Type6.Optional(AgentRunStatusSchema),
  submissionId: Type6.Optional(Type6.String({ minLength: 1 }))
}, { $id: "AgentSendDetails", additionalProperties: false });
var AgentWaitUnusedResultSchema = Type6.Object({ unused: Type6.Literal(true) }, { additionalProperties: false });
var AgentWaitDetailsSchema = Type6.Object({
  ok: Type6.Literal(true),
  timedOut: Type6.Literal(false),
  results: Type6.Array(AgentWaitUnusedResultSchema, { maxItems: 0 }),
  pendingRunIds: Type6.Array(Type6.String({ minLength: 1 }), { minItems: 1 }),
  timeoutSeconds: Type6.Optional(Type6.Number({ minimum: 0 }))
}, { $id: "AgentWaitDetails", additionalProperties: false });
var AgentCloseDetailsSchema = Type6.Object({
  agentId: Type6.String({ minLength: 1 }),
  status: Type6.Literal("closed")
}, { $id: "AgentCloseDetails", additionalProperties: false });
var RecordAgentChildSessionStartFactsSchema = Type6.Object({
  agent_id: Type6.String({ minLength: 1 }),
  sessionId: Type6.Optional(Type6.String({ minLength: 1 })),
  sessionFile: Type6.Optional(Type6.String({ minLength: 1 }))
}, { $id: "RecordAgentChildSessionStartFacts", additionalProperties: false });
var RollbackUnacceptedAgentStartFactsSchema = Type6.Object({
  agent_id: Type6.String({ minLength: 1 }),
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.String({ minLength: 1 })
}, { $id: "RollbackUnacceptedAgentStartFacts", additionalProperties: false });
var RollbackAgentSendPreflightFactsSchema = Type6.Object({
  agent_id: Type6.String({ minLength: 1 }),
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.String({ minLength: 1 }),
  previous_submission_id: Type6.String(),
  outcome: AgentSendOutcomeSchema,
  previous_reason_code: Type6.Optional(AgentSuspensionReasonCodeSchema)
}, { $id: "RollbackAgentSendPreflightFacts", additionalProperties: false });
var RecordAgentSendDispatchFailureFactsSchema = Type6.Object({
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.Optional(Type6.String({ minLength: 1 })),
  error: Type6.Optional(Type6.String())
}, { $id: "RecordAgentSendDispatchFailureFacts", additionalProperties: false });
var RollbackFailedAgentInterruptionFactsSchema = Type6.Object({
  agent_id: Type6.String({ minLength: 1 }),
  run_id: Type6.String({ minLength: 1 })
}, { $id: "RollbackFailedAgentInterruptionFacts", additionalProperties: false });
var AgentDispatchCompletionSchema = Type6.Object({
  status: Type6.Union([Type6.Literal("completed"), Type6.Literal("failed"), Type6.Literal("cancelled"), Type6.Literal("timed_out")]),
  finalOutput: Type6.Optional(Type6.String()),
  resultEntryId: Type6.Optional(Type6.String({ minLength: 1 })),
  reason: Type6.Optional(Type6.String())
}, { $id: "AgentDispatchCompletion", additionalProperties: false });
var AgentDispatchCompletionFactsSchema = Type6.Object({
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.Optional(Type6.String({ minLength: 1 })),
  completion: AgentDispatchCompletionSchema
}, { $id: "AgentDispatchCompletionFacts", additionalProperties: false });
var AgentActivityFactsSchema = Type6.Object({
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.String({ minLength: 1 }),
  event: Type6.Union([
    Type6.Literal("agent_start"),
    Type6.Literal("turn_start"),
    Type6.Literal("turn_end"),
    Type6.Literal("tool_execution_start"),
    Type6.Literal("tool_execution_update"),
    Type6.Literal("tool_execution_end")
  ])
}, { $id: "AgentActivityFacts", additionalProperties: false });
var AgentDispatchBoundaryFactsSchema = Type6.Object({
  run_id: Type6.String({ minLength: 1 }),
  submission_id: Type6.String({ minLength: 1 }),
  previous_assistant_entry_id: Type6.Optional(Type6.String({ minLength: 1 }))
}, { $id: "AgentDispatchBoundaryFacts", additionalProperties: false });
var LiveAgentDispatchesFactsSchema = Type6.Object({
  live_agent_ids: Type6.Array(Type6.String({ minLength: 1 }))
}, { $id: "LiveAgentDispatchesFacts", additionalProperties: false });
var AgentRunIdFactsSchema = Type6.Object({ run_id: Type6.String({ minLength: 1 }) }, { $id: "AgentRunIdFacts", additionalProperties: false });
var FinishAgentWaitFactsSchema = Type6.Object({
  run_ids: Type6.Array(Type6.String({ minLength: 1 }), { minItems: 1 })
}, { $id: "FinishAgentWaitFacts", additionalProperties: false });
var AgentIdFactsSchema = Type6.Object({ agent_id: Type6.String({ minLength: 1 }) }, { $id: "AgentIdFacts", additionalProperties: false });
var CronPromptSelectionSchema = Type6.Union([
  Type6.Object({ status: Type6.Literal("cancelled") }, { additionalProperties: false }),
  Type6.Object({ status: Type6.Literal("selected"), selected: Type6.String({ minLength: 1 }) }, { additionalProperties: false })
], { $id: "CronPromptSelection" });
var HostToolResultFactsSchema = Type6.Object({ action: Type6.String({ pattern: "^(write_stdin|apply_patch|write|edit)$" }), details: Type6.Unknown() }, { $id: "HostToolResultFacts", additionalProperties: false });
var PreparedTextResultInputSchema = Type6.Object({ text: Type6.String(), details: Type6.Unknown() });
var ToolResultConstructionFactsSchema = Type6.Object({ prepared: Type6.Optional(PreparedTextResultInputSchema), extraDetails: Type6.Optional(Type6.Unknown()), error: Type6.Optional(Type6.String()), text: Type6.Optional(Type6.String()), details: Type6.Optional(Type6.Unknown()) }, { $id: "ToolResultConstructionFacts", additionalProperties: false });
var AgentNotificationDetailsSchema = Type6.Object({ notificationId: Type6.String({ pattern: "^agent_completion:.+" }) }, { $id: "AgentNotificationDetails", additionalProperties: false });
var PreparedAgentStartSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("agent_start"),
  text: Type6.String(),
  details: AgentStartDetailsSchema,
  prompt: Type6.String(),
  agentId: Type6.String({ minLength: 1 }),
  runId: Type6.String({ minLength: 1 }),
  submissionId: Type6.String({ minLength: 1 }),
  capabilityId: Type6.String({ minLength: 1 }),
  metadata: AgentSessionMetadataSchema
}, { $id: "PreparedAgentStart", additionalProperties: false });
var PreparedAgentSendSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("agent_send"),
  text: Type6.String(),
  details: AgentSendDetailsSchema,
  prompt: Type6.String(),
  agentId: Type6.String({ minLength: 1 }),
  dispatch: Type6.Boolean(),
  interrupt: Type6.Boolean(),
  dispatchDeliverAs: Type6.Union([Type6.Literal("steer"), Type6.Literal("followUp")]),
  runId: Type6.Optional(Type6.String({ minLength: 1 })),
  submissionId: Type6.Optional(Type6.String({ minLength: 1 })),
  previousSubmissionId: Type6.Optional(Type6.String({ minLength: 1 })),
  previousReasonCode: Type6.Optional(AgentSuspensionReasonCodeSchema),
  outcome: AgentSendOutcomeSchema,
  capabilityId: Type6.String({ minLength: 1 }),
  metadata: AgentSessionMetadataSchema
}, { $id: "PreparedAgentSend", additionalProperties: false });
var PreparedAgentWaitSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("agent_wait"),
  text: Type6.String(),
  details: AgentWaitDetailsSchema,
  runIds: Type6.Array(Type6.String({ minLength: 1 }), { minItems: 1 }),
  timeoutSeconds: Type6.Optional(Type6.Number({ minimum: 0 }))
}, { $id: "PreparedAgentWait", additionalProperties: false });
var PreparedAgentCloseSchema = Type6.Object({
  ok: Type6.Literal(true),
  action: Type6.Literal("agent_close"),
  text: Type6.String(),
  details: AgentCloseDetailsSchema,
  agentId: Type6.String({ minLength: 1 }),
  runIds: Type6.Array(Type6.String({ minLength: 1 })),
  deleteWorktree: Type6.Optional(Type6.Boolean()),
  worktreePath: Type6.Optional(Type6.String()),
  worktreeBranch: Type6.Optional(Type6.String()),
  mainRepositoryRoot: Type6.Optional(Type6.String()),
  isolation: Type6.Optional(Type6.Union([Type6.Literal("none"), Type6.Literal("worktree")])),
  capabilityId: Type6.String({ minLength: 1 })
}, { $id: "PreparedAgentClose", additionalProperties: false });
var AgentRoutingDiagnosticsResultSchema = Type6.Object({ diagnostics: Type6.Array(Type6.String()) }, { $id: "AgentRoutingDiagnosticsResult", additionalProperties: false });
var AgentNotificationSchema = Type6.Object({
  runId: Type6.String({ minLength: 1 }),
  customType: Type6.Literal("notification"),
  content: Type6.String({ minLength: 1 }),
  display: Type6.Literal(true),
  details: AgentNotificationDetailsSchema
}, { $id: "AgentNotification", additionalProperties: false });
var PendingAgentNotificationsResultSchema = Type6.Object({ notifications: Type6.Array(AgentNotificationSchema) }, { $id: "PendingAgentNotificationsResult", additionalProperties: false });
var AgentNotificationClaimValidationSchema = Type6.Object({ valid: Type6.Boolean() }, { $id: "AgentNotificationClaimValidation", additionalProperties: false });
var AgentActiveCountResultSchema = Type6.Object({ count: Type6.Integer({ minimum: 0 }) }, { $id: "AgentActiveCountResult", additionalProperties: false });
var AgentCleanupItemSchema = Type6.Object({ agentId: Type6.String({ minLength: 1 }) }, { $id: "AgentCleanupItem", additionalProperties: false });
var AgentCleanupPlanSchema = Type6.Object({ agents: Type6.Array(AgentCleanupItemSchema) }, { $id: "AgentCleanupPlan", additionalProperties: false });
var AgentManagerIdentitySchema = Type6.Object({
  agentId: Type6.String({ minLength: 1 }),
  kind: AgentKindSchema,
  model: Type6.String({ minLength: 1 }),
  thinking: Type6.String({ minLength: 1 }),
  workspace: Type6.String({ minLength: 1 }),
  isolation: Type6.Optional(Type6.Union([Type6.Literal("none"), Type6.Literal("worktree")])),
  effectiveWorkspace: Type6.Optional(Type6.String({ minLength: 1 })),
  tier: Type6.Optional(Type6.Union([Type6.Literal("low"), Type6.Literal("medium"), Type6.Literal("high")])),
  createdAt: Type6.Integer(),
  childSessionFile: Type6.Optional(Type6.String({ minLength: 1 }))
}, { $id: "AgentManagerIdentity", additionalProperties: false });
var AgentManagerRunSchema = Type6.Object({
  runId: Type6.String({ minLength: 1 }),
  agentId: Type6.String({ minLength: 1 }),
  status: AgentRunStatusSchema,
  reasonCode: Type6.Optional(AgentReasonCodeSchema),
  startedAt: Type6.Integer(),
  endedAt: Type6.Optional(Type6.Integer()),
  suspendedAt: Type6.Optional(Type6.Integer()),
  description: Type6.String(),
  turnCount: Type6.Integer({ minimum: 0 }),
  lastActivityAt: Type6.Optional(Type6.Integer()),
  activityState: Type6.Union([
    Type6.Literal("starting"),
    Type6.Literal("reasoning"),
    Type6.Literal("using_tool"),
    Type6.Literal("orphaned"),
    Type6.Literal("inactive")
  ]),
  recommendation: Type6.Union([
    Type6.Literal("wait"),
    Type6.Literal("interrupt_or_close"),
    Type6.Literal("call_agent_wait"),
    Type6.Literal("resume_or_close")
  ]),
  submissionId: Type6.String({ minLength: 1 }),
  error: Type6.Optional(Type6.String()),
  announcement: Type6.Union([
    Type6.Literal("pending"),
    Type6.Literal("observed_by_agent_wait"),
    Type6.Literal("notification_sent")
  ])
}, { $id: "AgentManagerRun", additionalProperties: false });
var AgentManagerSnapshotSchema = Type6.Object({
  agents: Type6.Array(AgentManagerIdentitySchema),
  runs: Type6.Array(AgentManagerRunSchema)
}, { $id: "AgentManagerSnapshot", additionalProperties: false });
var AgentChildSessionUpdateSchema = Type6.Object({
  action: Type6.Union([
    Type6.Literal("stop_child_session"),
    Type6.Literal("delete_child_session")
  ]),
  key: Type6.String({ minLength: 1 }),
  reason: Type6.String({ minLength: 1 })
}, { $id: "AgentChildSessionUpdate", additionalProperties: false });
var ProcessManagerEntrySchema = Type6.Object({
  sessionId: Type6.Integer({ minimum: 0 }),
  command: Type6.String(),
  runState: Type6.Union([Type6.Literal("running"), Type6.Literal("exited")]),
  exitCode: Type6.Optional(Type6.Integer()),
  ageSeconds: Type6.Integer({ minimum: 0 }),
  retained: Type6.Boolean()
}, { $id: "ProcessManagerEntry", additionalProperties: false });
var ProcessManagerSnapshotSchema = Type6.Object({ sessions: Type6.Array(ProcessManagerEntrySchema) }, { $id: "ProcessManagerSnapshot", additionalProperties: false });
var ProcessManagerOutputSchema = Type6.Object({ available: Type6.Boolean(), text: Type6.String() }, { $id: "ProcessManagerOutput", additionalProperties: false });
var ProcessManagerOwnerFactsSchema = Type6.Object({ ownerId: Type6.String({ minLength: 1 }) }, { $id: "ProcessManagerOwnerFacts", additionalProperties: false });
var ProcessManagerSessionFactsSchema = Type6.Object({
  ownerId: Type6.String({ minLength: 1 }),
  sessionId: Type6.Integer({ minimum: 0 })
}, { $id: "ProcessManagerSessionFacts", additionalProperties: false });
var PreparedToolActionSchema = Type6.Union([
  GatewayCommandErrorSchema,
...
// src/version.ts
var taumelVersion = "0.0.323-g0f570b5d1df9";
...
function renderAgentInspection(agent, run, instruction, theme, width, nowMs = Date.now()) {
  const w = Math.max(1, width);
...
async function showAgentInspection(ui, agent, run, instruction) {

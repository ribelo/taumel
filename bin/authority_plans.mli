...
val issue_exec :
  owner_id:string ->
  owner_context:Js_of_ocaml.Js.Unsafe.any ->
...
val approve_exec :
  owner_context:Js_of_ocaml.Js.Unsafe.any -> string -> (unit, string) result
...
val reissue_exec_retry :
  owner_context:Js_of_ocaml.Js.Unsafe.any -> string -> (string, string) result
...
val consume_exa :
  owner_context:Js_of_ocaml.Js.Unsafe.any -> string -> (exa_plan, string) result
...
val ratchet_agent_action_state :
  owner_id:string ->
  action:agent_action ->
  agent_id:string ->
  owner_epoch:int ->
...
val adopt_agent_action_transition :
  owner_id:string ->
  action:agent_action ->
  agent_id:string ->
  owner_epoch:int ->
...
val complete_agent_action_transition :
  owner_id:string ->
  action:agent_action ->
  agent_id:string ->
  owner_epoch:int ->

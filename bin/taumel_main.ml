...
let core_call name_js args_js =
  ...
  | "planActiveToolsSync" ->
      Tool_catalog_bridge.plan_active_tools_sync_js (arg 0)
  | "planEnvironmentContext" ->
      Environment_context_bridge.plan_context (arg 0) (arg 1)
  | "planSkillExpansion" -> Skill_tools.plan_expansion (arg 0)
  | "listSkills" -> Skill_tools.list_skills (arg 0)
  | "planCompactionModelCommand" -> Compaction_model_bridge.plan_command (arg 0)
  ...
  | "appendExecPolicyAllowRule" -> Exec_policy_bridge.append_allow_rule (arg 0)
  ...
  | "applyPatchToFiles" -> Mutation_tools.apply_patch_to_files (arg 0)
  | "applyEditToFile" -> Mutation_tools.apply_edit_to_file (arg 0)
  | "planExecHostCall" -> Sandbox_bridge.plan_exec_host_call (arg 0) (arg 1)
  | "formatExecResult" ->
      Sandbox_bridge.format_exec_result (arg 0) (arg 1) (arg 2) (arg 3)
  | "planExecApprovalPrompt" -> Sandbox_bridge.plan_exec_approval_prompt (arg 0)
  ...
  | "runExecCommand" ->
      Exec_session.run_exec_command (arg 0) (string_arg args 1) (arg 2) (arg 3)
  | "writeExecStdin" -> Exec_session.write_stdin (arg 0)
  ...
  | "awaitExecCompletion" -> Exec_session.await_exec_completion (int_arg args 0)
  ...
  | "processManagerKill" ->
      ...
      Exec_session.process_manager_kill
        ...
        (Tool_contracts.ProcessManagerSessionFacts.get_sessionId facts
        |> int_of_float)
  | "planCommandExecution" -> Command_bridge.plan_execution (arg 0)
  | "planPlanContinuation" -> Plan_tools.plan_continuation (arg 0)
  ...
  | "persistRalphControllerState" ->
      Ralph_tools.persist_controller_state (arg 0)
  ...
  | "prepareAgentCloseStop" ->
      Agent_action_capability.prepare_close_stop (arg 0)
  | "completeAgentCloseStop" ->
      Agent_action_capability.complete_close_stop (arg 0)
  ...
  | "deleteAgentWorktree" ->
      Agent_tools.delete_worktree (arg 0)
        (Agent_tools.agent_owner_context (arg 1))
  | "reconcileProvisionalAgentWorktrees" ->
      Agent_tools.reconcile_provisional_worktrees ()
      ...
      let program =
        ...
        |> Eta.Effect.bind (fun clean ->
            if clean then Eta.Effect.pure (core_ack ())
              ...
              Eta.Effect.fail
                "cleanup_failed: could not terminate identity-owned broker \
                 sessions")
      in
  ...
  | "finishPermissionsPrompt" -> Permissions_commands.finish_prompt (arg 0)
  | "toolResultEnvelope" ->
      let facts =
      ...
      in
      let prepared =
        Tool_contracts.ToolResultConstructionFacts.get_prepared facts
      in
      let extra =
        Tool_contracts.ToolResultConstructionFacts.get_extraDetails facts
      in
      ...
      let details =
        Tool_contracts.ToolResultConstructionFacts.get_details facts
      in
      ...
      | None, None, None, Some _, _ ->
          ()
      | _ ->
          invalid_arg "tool result construction facts select exactly one branch");
  ...
  | "hostToolResult" ->
      ...
      in
      host_tool_result
        (Tool_contracts.HostToolResultFacts.t_to_js facts |> js_of_ojs)
  ...
  | "kimiUsageHostAuth" -> Usage_bridge.kimi_host_auth ()
  | "openAiUsageHostParams" -> Usage_bridge.openai_host_params (arg 0)
  | "kimiUsageHostParams" -> Usage_bridge.kimi_host_params (arg 0)
  | "executeOpenAiUsage" -> Usage_bridge.execute_openai (arg 0) (arg 1)
  | "executeUsagePair" -> Usage_bridge.execute_pair (arg 0) (arg 1)
